<footer class="bg-[#0a0e30] dark:bg-gray-900">
	<div class="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
		<div class="flex justify-center text-teal-600 dark:text-teal-300">
			<img src="logo.png" alt="IC-Best Link Telecom Corporation logo" width="250" height="100" />
		</div>

		<p class="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500 dark:text-gray-400">
			IC-Best Link Telecom Corporation <br />
		...
		<p class="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-300 dark:text-gray-300">
