...
<section class="px-4 pb-10 md:pb-20 mx-auto lg:max-w-7xl" id="services">
	<header class="py-4 text-center">
		...
		<p class="text-primary text-gray-600 text-base md:text-lg my-4">
			From specialized system services to comprehensive end-to-end solutions—including networking,
			security, telephony, structured cabling, and integrated communications—we empower your
			business with speed, efficiency, and modern connectivity. Rely on our trusted, high-quality
			services to keep your operations running smoothly and seamlessly.
		</p>
	</header>

	<!-- Moving banner -->
	<section class="pt-2 pb-6 px-0 md:pt-8 md:pb-16 relative flex gap-4 items-center">
		<div class="wrapper">
			<div class="marquee">
		...
		>
			<div class="svg-wrapper">
				...
				>
					...
					<circle cx="220" cy="350" r="125" fill="#014e89" filter="url(#blurFilterOne)" />

					<circle cx="380" cy="335" r="125" fill="#46a8c3" filter="url(#blurFilterOne)" />
				</svg>
			</div>

			<div class="grid lg:grid-cols-2 sm:gap-4 gap-10 items-center relative z-99">
				<div>
					<p class="text-[#110467] sm:text-sm uppercase font-bold text-sm mb-3">Services</p>
					<h2 class="text-primary sm:text-2xl text-lg font-semibold mb-6 md:mb-8">
				...
				<div>
					<div>
						<img class="-mr-5" width="625" height="580" src="/services1.webp" alt="service page" />
					</div>
				</div>
			</div>
		</div>
		...
		>
			<div class="svg-wrapper-2">
				...
				>
					...
					<circle cx="320" cy="250" r="120" fill="#4a4bf6" filter="url(#blurFilterOne)" />

					<circle cx="180" cy="235" r="125" fill="#f2dbfc" filter="url(#blurFilterOne)" />
				</svg>
			</div>
			<div class="grid lg:grid-cols-2 sm:gap-4 gap-10 items-center relative z-99">
				<div class="order-2 md:order-1">
					<img class="-mr-5" width="625" height="580" src="/services2.webp" alt="service page" />
				</div>
